...
<div class="mondriaan-strip">
    <span style="flex:3; background:var(--red);"></span>
    <span style="flex:1.3; background:var(--page);"></span>
    <span style="flex:2; background:var(--yellow);"></span>
